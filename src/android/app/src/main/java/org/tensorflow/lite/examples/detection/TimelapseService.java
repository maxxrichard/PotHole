...
public class TimelapseService extends Service {
	...
	public static String getExternalSdCardPath() {
		...
		List<String> sdCardPossiblePath = Arrays.asList("external_sd", "ext_sd", "external", "extSdCard", "sdcard2", "SD card");
	...
	private void setupOutdir() {
		...
		outdir = getExternalSdCardPath() + "/saved_stream/" + now.format("%Y%m%d-%H%M%S/");
		//outdir = Environment.getExternalStorageDirectory().getPath() + "/saved_stream/" + now.format("%Y%m%d-%H%M%S/");
