...
public class Timelapse extends Activity {
	...
	private final OnClickListener mAboutListener = new OnClickListener() {
		public void onClick( View v ) {
			String msg = "Background capture stream\n Continuously captures HD images in the background for timelapse videos.\n\nStart: start the capture service\nStop: shut down the service\nAbout: Pothole app feature to continuously capture frames\nDelay: milliseconds between captures";
